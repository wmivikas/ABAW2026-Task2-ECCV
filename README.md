...
[![arXiv](https://img.shields.io/badge/arXiv-2607.11120-b31b1b.svg)](https://arxiv.org/abs/2607.11120)
...
**[📄 Paper](https://arxiv.org/abs/2607.11120)** · **[⚡ Quick start](#quick-start)** · **[📊 Results](#results)** · **[📁 File map](#file-map)**
...
- **ASR-erased time** — a signal we introduce: speech recognisers delete fillers
...
- **The key decision is calibration, not architecture.** Tuning ensemble weights
  ...
  threshold at 0.5 gives **0.731** — that one change is worth more than any
...
```bibtex
@article{kumar2026simple,
  title   = {Simple Features and Honest Calibration for Ambivalence and
             Hesitancy Recognition in Video},
  author  = {Kumar, Vikas and Mishra, Aditya and Lone, Hroon R.},
  journal = {arXiv preprint arXiv:2607.11120},
  year    = {2026},
  url     = {https://arxiv.org/abs/2607.11120}
}
```
